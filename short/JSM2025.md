...
<div class="schedule-container">
    <table class="schedule-table">
        ...
        <tr class="schedule-row">
            <td><a href="../assets/JSM_slides/JSM_DL_Intro.pdf">Foundations of Deep Learning Methods</a>
            </td>
            <td>TBD</td>
            <td class="bold-text">Hongtu Zhu</td>
        </tr>
        <tr>
            <td><a href="../assets/JSM_slides/computation.pdf">Computational Resources and Examples</a></td>
            <td>TBD</td>
            <td class="bold-text">Runpeng Dai</td>
        </tr>
        <tr class="schedule-row">
            <td><a href="../assets/JSM_slides/JSM_GenAI.pdf">Deep Generative Models</a></td>
            <td>TBD</td>
            <td class="bold-text">Xiao Wang</td>
        </tr>
        <tr>
            <td><a href="../assets/JSM_slides/JSM_Transformer.pdf">Attention and Transformer</a></td>
            <td>TBD</td>
            <td class="bold-text">Xiao Wang</td>
        </tr>
        <tr>
            <td><a href="../assets/JSM_slides/JSM_SeqST.pdf">Deep Sequence Modeling and Spatio-temporal Modeling</a></td>
            <td>TBD</td>
            <td class="bold-text">Hongtu Zhu</td>
        </tr>
        <tr>
            <td><a href="../assets/JSM_slides/Large Language Models.pdf">Large Language Models</a></td>
            <td>TBD</td>
            <td class="bold-text">Runpeng Dai</td>
        </tr>
        <tr>
            <td><a href="../assets/JSM_slides/JSM_DL_App.pdf">Deep Learning in Advanced Statistical Problems</a></td>
            <td>TBD</td>
            <td class="bold-text">Hongtu Zhu</td>
        </tr>
    </table>
