...
<div class="schedule-container">
    <table class="schedule-table">
        ...
        <tr class="schedule-row">
            <td>Foundations of Deep Learning Methods
            </td>
            <td>TBD</td>
            <td class="bold-text">Hongtu Zhu</td>
        </tr>
        <tr>
            <td>Computational Resources and Examples</td>
            <td>TBD</td>
        ...
        <tr class="schedule-row">
            <td>Deep Sequence Modeling and Spatio-temporal Modeling</td>
            <td>TBD</td>
            <td class="bold-text">Hongtu Zhu</td>
        </tr>
        <tr>
        ...
        <tr class="schedule-row">
            <td>Deep Learning in Advanced Statistical Problems</td>
            <td>TBD</td>
            <td class="bold-text">Hongtu Zhu</td>
        </tr>
    </table>
