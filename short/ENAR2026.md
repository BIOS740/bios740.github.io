...
🎥 Recordings: Recordings for each section have been uploaded. If you are interested, please contact us via email for access.

📊 Slides: Finalized slides have been released. Click each section name for access.
...
<div class="schedule-container">
    <table class="schedule-table">
        ...
        <tr class="schedule-row">
            <td><a href="../assets/ENAR_slides/Intro.pdf">Chapter 1: Foundations of Deep Learning Methods</a>
            </td>
            <td>3h</td>
            <td class="bold-text">Hongtu Zhu</td>
        </tr>
        <tr>
            <td><a href="../assets/ENAR_slides/computation.pdf">Chapter 2: Computational Resources and Examples</a></td>
            <td>1h</td>
            <td class="bold-text">Runpeng Dai</td>
        </tr>
        <tr class="schedule-row">
            <td><a href="../assets/ENAR_slides/GenAI.pdf">Chapter 3: Deep Generative Models</a></td>
            <td>1.5h</td>
            <td class="bold-text">Xiao Wang</td>
        </tr>
        <tr>
            <td><a href="../assets/ENAR_slides/Transformer.pdf">Chapter 4: Attention and Transformer</a></td>
            <td>1.5h</td>
            <td class="bold-text">Xiao Wang</td>
        </tr>
        <tr>
            <td><a href="../assets/ENAR_slides/LLM.pdf">Chapter 5: Large Language Models</a></td>
            <td>1h</td>
            <td class="bold-text">Runpeng Dai</td>
        </tr>
    </table>
...
<p>
    <strong><a href="https://runpengdai.github.io/">Runpeng Dai</a></strong> is a third-year Ph.D. candidate at the University of North Carolina at Chapel Hill, advised by Prof. Hongtu Zhu. Before that, he obtained his B.S in Statistics from the Shanghai University of Finance and Economics where he was advised by Prof. Fan Zhou. His research sits at the intersection of Reinforcement Learning and LLM Reasoning, bridging theory and practice in AI.
  </p>
</div>